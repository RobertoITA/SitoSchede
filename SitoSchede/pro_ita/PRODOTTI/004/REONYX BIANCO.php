...
<table class="header-table" style="width: 94%; border-collapse: collapse;">
        <tr>
            ...
            <td class="left-column" style="vertical-align: top; text-align: left;">
                <div>
                    <span>SCHEDA NUMERO: 004</span><br>
            ...
            <td style="text-align: right;">
                <img src="004.png" alt="Immagine della scheda" class="scheda-img">
            </td>
        </tr>
    </table>
    <table class="info-table">
        ...
        <tr>
            ...
            <td>1,63 Kg/l ± 0,05 a 20°C (KGP1014: 1,50 Kg/l ± 0,05 a 20°C)</td>
        </tr>
        <tr>
            <th>RESIDUO SECCO</th>
            <td>58 ± 0,5 % p/p</td>
